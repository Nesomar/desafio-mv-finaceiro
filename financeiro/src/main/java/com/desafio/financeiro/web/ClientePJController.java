...
import com.desafio.financeiro.service.ClientePJService;
...
@RestController
@RequestMapping(path = "/clientes-pj", produces = MediaType.APPLICATION_PROBLEM_JSON_VALUE)
...
public class ClientePJController {
	...
	@GetMapping
	@ApiOperation(value = "Listar todas os Clientes PJ cadastradas.", tags = { "Clientes PJ" })
	...
	@GetMapping("/{id}")
	@ApiOperation(value = "Consultar uma Cliente PJ por id", tags = { "Clientes PJ" })
	...
	@PostMapping
	@ApiOperation(value = "Cadastrar um Cliente PJ", tags = { "Clientes PJ" })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Sucesso"), @ApiResponse(code = 400, message = "Erro") })
	...
	@PutMapping("/{id}")
	@ApiOperation(value = "Alterar as informações de Cliente PJ", tags = { "Clientes PJ" })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Sucesso"),
	...
	@DeleteMapping("/{id}")
	@ApiOperation(value = "Inativar um Cliente PJ por id", tags = { "Clientes PJ" })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Sucesso"), @ApiResponse(code = 400, message = "Erro"),
			@ApiResponse(code = 404, message = "Não Encontrado") })
